...
def open_valores_colunas():
    try:
        ...
        show_error(
            "Erro: O arquivo 'config/valores_colunas.json' não pode ser lido. Verifique o formato JSON."
        )
...
def open_valores_label():
    try:
        ...
        show_error(
            "Erro: O arquivo 'config/valores_label.json' não pode ser lido. Verifique o formato JSON."
        )
    except Exception as e:
...
def open_valores_item():
    try:
        ...
        show_error(
            "Erro: O arquivo 'config/valores_item.json' não pode ser lido. Verifique o formato JSON."
        )
    except Exception as e:
