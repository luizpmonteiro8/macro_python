...
def get_copiar_coeficiente_comp(dados):
    return dados.get("composicaoCoeficienteCopiar", "L")


def get_preco_unitario_comp(dados):
    return dados.get("composicaoPrecoUnitario", "F")


def get_copiar_preco_unitario_comp(dados):
    return dados.get("composicaoPrecoUnitarioCopiar", "M")


def get_coluna_totais_comp(dados):
    return dados.get("colunaTotaisComposicao", "E")


def get_valor_totais_comp(dados):
    return dados.get("valorTotaisComposicao", "G")


def get_valor_comp(dados):
...
def get_coeficiente_aux(dados):
    return dados.get("auxiliarCoeficiente", "E")


def get_copiar_coeficiente_aux(dados):
    return dados.get("auxiliarCoeficienteCopiar", "L")


def get_preco_unitario_aux(dados):
    return dados.get("auxiliarPrecoUnitario", "F")


def get_copiar_preco_unitario_aux(dados):
    return dados.get("auxiliarPrecoUnitarioCopiar", "M")


def get_coluna_totais_aux(dados):
    return dados.get("colunaTotaisAuxiliar", "E")


def get_valor_totais_aux(dados):
    return dados.get("valorTotaisAuxiliar", "G")
...
def get_coluna_total_resumo(dados):
    return dados.get("colunaTotalResumo", "C")
