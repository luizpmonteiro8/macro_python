...
def get_label_planilha_orcamentaria(valores):
    return valores["planilhaOrcamentaria"].get(
        "planilhaOrcamentariaNome", "Planilha orcamentaria"
    )


def get_title_planilha_orcamentaria(valores):
    return valores["planilhaOrcamentaria"].get(
        "tituloPlanilhaOrcamentaria", "PLANILHA ORÇAMENTARIA"
    )


def get_label_coluna_inicial(valores):
    return valores["planilhaOrcamentaria"].get("colunaicial", "Coluna inicial")


def get_label_coluna_final(valores):
    return valores["planilhaOrcamentaria"].get("colunaFinal", "Coluna final")


def get_label_valor_inicial(valores):
    return valores["planilhaOrcamentaria"].get("valorInicial", "Valor inicial")


def get_label_valor_final(valores):
    return valores["planilhaOrcamentaria"].get("valorFinal", "Valor final")


def get_label_preco_unitario_copiar(valores):
    return valores["planilhaOrcamentaria"].get(
        "precoUnitarioCopiar", "Preço unitário copiar"
    )
...
def get_title_planilha_fator(valores):
    return valores["planilhaFator"].get("tituloPlanilhaFator", "PLANILHA FATOR")
...
def get_title_planilha_aux(valores):
    return valores["planilhaAuxiliar"].get(
        "tituloPlanilhaAuxiliar", "PLANILHA AUXILIAR"
    )


def get_label_planilha_aux(valores):
    return valores["planilhaAuxiliar"].get("planilhaAuxiliar", "Planilha auxiliar")


# composicao
def get_title_planilha_composicao(valores):
    return valores["planilhaComposicao"].get(
        "tituloPlanilhaComposicao", "PLANILHA COMPOSICAO"
    )


def get_label_planilha_composicao(valores):
    return valores["planilhaComposicao"].get("planilhaComposicao", "Composicoes")
...
def get_label_composicao_auxiliar_coeficiente_copiar(valores):
    return valores["planilhaComposicaoAuxiliar"].get(
        "coeficienteCopiar", "Coluna copiar coeficiente"
    )


def get_label_composicao_auxiliar_preco_unitario_copiar(valores):
    return valores["planilhaComposicaoAuxiliar"].get(
        "precoUnitarioCopiar", "Coluna copiar preço unitário"
    )


def get_label_composicao_auxiliar_coluna_totais(valores):
    return valores["planilhaComposicaoAuxiliar"].get("colunaTotais", "Coluna totais")


def get_label_composicao_auxiliar_valor_totais(valores):
    return valores["planilhaComposicaoAuxiliar"].get("valorTotais", "Valor totais")


def get_label_valor_bdi_comp(valores):
    return valores["planilhaComposicao"].get("valorBdi", "Valor BDI")


def get_label_valor_total_comp(valores):
...
def get_label_valor_comp(valores):
    return valores["planilhaComposicao"].get("valor", "Valor")
