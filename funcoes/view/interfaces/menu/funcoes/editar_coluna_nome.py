...
def atualizar_dropdown(menu_dropdown, frame_menu, dropdown_valor):
    ...
    menu_dropdown = tk.OptionMenu(frame_menu, dropdown_valor, *nomes_colunas)
...
def local_abrir_janela_editar(self, menu_dropdown, frame_menu, dropdown_valor):
