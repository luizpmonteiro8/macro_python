...
from funcoes.get.get_valores_label import (
    ...
    get_label_composicao_auxiliar_valor_totais,
    get_label_descricao,
...
def interface_plan_composicao(self, frame_aux):
    ...
    title_frame_aux = tk.Label(
        frame_aux, text=get_title_planilha_composicao(valores_label), font=(None, 18)
    )
    title_frame_aux.grid(row=0, column=0, sticky="w", padx=10)

    # Variáveis StringVar
    var_planilha_composicao = tk.StringVar(value=get_planilha_comp(self.dados))
    var_descricao_composicao = tk.StringVar(value=get_descricao_comp(self.dados))
    var_item_descricao_composicao = tk.StringVar(
        value=get_item_descricao_comp_aux(self.dados)
    )
    var_coefiente_composicao = tk.StringVar(value=get_coeficiente_comp(self.dados))
    ...
    self.entry_planilha_comp = custom_input(
        frame_aux,
        get_label_planilha_composicao(valores_label),
        var_planilha_composicao.get(),
        row=1,
    )
    ...
    self.entry_descricao_comp = custom_input(
        frame_aux,
        get_label_descricao(valores_label),
        var_descricao_composicao.get(),
        row=2,
    )
    ...
    self.entry_item_descricao_comp = custom_input(
        frame_aux,
        get_label_coluna_item(valores_label),
        var_item_descricao_composicao.get(),
        row=3,
    )
    ...
    self.entry_coeficiente_comp = custom_input(
        frame_aux,
        get_label_coeficiente(valores_label),
        var_coefiente_composicao.get(),
        row=4,
    )
    ...
    self.entry_preco_unitario_comp = custom_input(
        frame_aux,
        get_label_preco_unitario(valores_label),
        var_preco_unitario_composicao.get(),
        row=5,
    )
    ...
    self.entry_coeficiente_copiar_comp = custom_input(
        frame_aux,
        get_label_composicao_auxiliar_coeficiente_copiar(valores_label),
        var_coefiente_copiar_composicao.get(),
        row=6,
    )
    ...
    self.entry_preco_unit_copiar_comp = custom_input(
        frame_aux,
        get_label_composicao_auxiliar_preco_unitario_copiar(valores_label),
        var_preco_unit_copiar_composicao.get(),
        row=7,
    )
    ...
    self.entry_coluna_totais_comp = custom_input(
        frame_aux,
        get_label_composicao_auxiliar_coluna_totais(valores_label),
        var_coluna_totais_composicao.get(),
        row=8,
    )
    ...
    self.entry_valor_totais_comp = custom_input(
        frame_aux,
        get_label_composicao_auxiliar_valor_totais(valores_label),
        var_valor_totais_composicao.get(),
        row=9,
    )

    # valor
    self.entry_valor_comp = custom_input(
        frame_aux,
        get_label_valor_comp(valores_label),
        var_valor_comp.get(),
        row=10,
    )

    # valor BDI
    self.entry_valor_bdi_comp = custom_input(
        frame_aux,
        get_label_valor_bdi_comp(valores_label),
        var_valor_bdi_comp.get(),
        row=11,
    )
