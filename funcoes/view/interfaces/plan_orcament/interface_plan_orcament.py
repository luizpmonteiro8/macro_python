...
def interface_plan_orcamentaria(self, frame_orcamentaria):
    ...
    title_frame_fator = tk.Label(
        frame_orcamentaria,
        text=get_title_planilha_orcamentaria(valores_label),
        font=(None, 18),
    )
    ...
    var_plan_codigo = tk.StringVar(value=get_planilha_codigo(self.dados))
    var_plan_descricao = tk.StringVar(value=get_planilha_descricao(self.dados))
    var_plan_quantidade = tk.StringVar(value=get_planilha_quantidade(self.dados))
    var_plan_preco_unitario = tk.StringVar(
        value=get_planilha_preco_unitario(self.dados)
    )
    var_plan_preco_total = tk.StringVar(value=get_planilha_preco_total(self.dados))
    ...
    self.entry_planilha_orcamentaria = custom_input(
        frame_orcamentaria,
        get_label_planilha_orcamentaria(valores_label),
        var_planilha_orcamentaria.get(),
        row=1,
    )
    ...
    self.entry_coluna_inicial = custom_input(
        frame_orcamentaria,
        get_label_coluna_inicial(valores_label),
        var_coluna_inicial.get(),
        row=2,
    )
    ...
    self.entry_coluna_final = custom_input(
        frame_orcamentaria,
        get_label_coluna_final(valores_label),
        var_coluna_final.get(),
        row=3,
    )
    ...
    self.entry_valor_inicial = custom_input(
        frame_orcamentaria,
        get_label_valor_inicial(valores_label),
        var_valor_inicial.get(),
        row=4,
    )
    ...
    self.entry_valor_final = custom_input(
        frame_orcamentaria,
        get_label_valor_final(valores_label),
        var_valor_final.get(),
        row=5,
    )
    ...
    self.entry_planilha_codigo = custom_input(
        frame_orcamentaria,
        get_label_codigo(valores_label),
        var_plan_codigo.get(),
        row=6,
    )
    ...
    self.entry_planilha_quantidade = custom_input(
        frame_orcamentaria,
        get_label_quantidade(valores_label),
        var_plan_quantidade.get(),
        row=8,
    )
    ...
    self.entry_planilha_preco_total = custom_input(
        frame_orcamentaria,
        get_label_preco_total(valores_label),
        var_plan_preco_total.get(),
        row=10,
    )
    ...
    self.entry_plan_preco_unit_copiar = custom_input(
        frame_orcamentaria,
        get_label_preco_unitario_copiar(valores_label),
        var_plan_preco_unitario_copiar.get(),
        row=11,
    )
